...
router.post("/userWithdrawList",userControllers.userWithdrawList);
  router.post("/goLive",userControllers.goLive);
   router.post("/generateToken",userControllers.generateToken); 
  router.post("/deleteliveToken",userControllers.deleteliveToken);
  router.post("/userDashboard",userControllers.userDashboard);
  router.post("/coordinatorWithdrawRequest",userControllers.coordinatorWithdrawRequest);
router.post("/coordinatorWithdrawList",userControllers.coordinatorWithdrawList);
